...
main = do
    ...
    Sock.withSocketsDo $ runMateM (Config (fromJust $ parseAddress "134.28.70.172") 1337 dim (Just 33000) True [sdlKeyEventProvider, sdlJoystickEventProvider]) eventTest (0,0)
